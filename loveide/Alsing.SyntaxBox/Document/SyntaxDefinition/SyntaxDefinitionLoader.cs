...
namespace Alsing.SourceCode
{
    ...
    public class SyntaxDefinitionLoader
    {
        ...
        private void ParseStyle(XmlNode node)
        {
            ...
            if (BackColor != "")
            {
                if (BackColor.Length == 7 && BackColor[0] == '#')
                {
                    var r = Convert.ToInt32(BackColor.Substring(1, 2), 16);
                    var g = Convert.ToInt32(BackColor.Substring(3, 2), 16);
                    var b = Convert.ToInt32(BackColor.Substring(5, 2), 16);
                    st.BackColor = Color.FromArgb(r, g, b);
                }
                else
                {
            ...
            if (ForeColor != "")
            {
                if (ForeColor.Length == 7 && ForeColor[0] == '#')
                {
                    var r = Convert.ToInt32(ForeColor.Substring(1, 2), 16);
                    var g = Convert.ToInt32(ForeColor.Substring(3, 2), 16);
                    var b = Convert.ToInt32(ForeColor.Substring(5, 2), 16);
                    st.ForeColor = Color.FromArgb(r, g, b);
                }
                else
                {
